...
<div class="list-group "><?php  if (isset($_SESSION['username'])) : ?>
 <center><p class="list-group-item" style="opacity: 1; padding-bottom: 40px; " ><img src="../uploads/default.png" class="user_image"><strong><br><?php echo $_SESSION['username']; ?><br><br></strong> 
  <?php endif ?>
<?php  if (isset($_SESSION['username'])) : ?>
...
<a href="" type="button" data-toggle="modal" data-target="#viewMyMessages" title="View Your Inbox Messages"><span  style="float: right; margin-right: 5%;" title="View Your Inbox Messages" class="glyphicon glyphicon-envelope pull-left glyphicon_icons" aria-hidden="true"></span></a></p></center>
...
<div id="hidden" class="collapse" style="text-align: center;">
   ...
   " class="list-group-item add_item" title="Add New Items"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Add Employees</a>
      <a href="" type="button" data-toggle="modal" data-target="#addBranch
   " class="list-group-item add_item" title="Add New Items"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Add Branches</a>
   <a href="" type="button" data-toggle="modal" data-target="#addServices
   " class="list-group-item add_item" title="Add New Items"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Add Services</a>
...
<div id="deleteBranches" class="collapse" style="text-align: center;">
    ...
    <select onchange="this.form.submit();" name="btn_delete_branch">
      <option selected data-default>Select to delete</option>
      <?php 
                $stmt = $db_conn->prepare('SELECT * FROM our_branches ORDER BY id ASC');
                  $stmt->execute();
                  if ($stmt->rowCount() > 0) 
                  {
                    while($row = $stmt->fetch(PDO::FETCH_ASSOC))
 ...
 <a href="#" class="list-group-item" title="Add New Items" ><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Categories</a>
  ...
  <a href="#" class="list-group-item"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Posts <span class="badge">51</span> </a>
 <a href="#" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Admin Members<span class="badge">1</span> </a>
  <a href="#" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Subscribers <span class="badge">50</span> </a>
        ...
        <div class="panel-body">
          ...
          <div class="col-md-4">
            <div class="well dash-box" style="background: #f5fffa;">
              <h2><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 51</h2>
              <h4>Posts</h4>
            </div>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table class="table table-striped table-hover">
            ...
            <tr>
              <th>1</th><?php  if (isset($_SESSION['username'])) : ?>
              <th><a href="" type="button" data-toggle="modal" data-target="#viewMyProfile" title="View User Profile"><span style="color:black;" title="View User Profile" class="glyphicon glyphicon-open " aria-hidden="true"></span> <m style="color:black; text" ><strong><?php echo $_SESSION['username']; ?></strong></m></th></a>
              <?php endif ?>
            ...
            <tr>
              <th>2</th>
              <th><a href="" type="button" data-toggle="modal" data-target="#viewMyProfile" title="View User Profile"><span style="color:black;" title="View User Profile" class="glyphicon glyphicon-open " aria-hidden="true"></span> <m style="color:black; text" >Dylan Victory</m></th></a>
              <th>Subscriber</th>
            </tr>
            <tr>
              <th>3</th>
              <th><a href="" type="button" data-toggle="modal" data-target="#viewMyProfile" title="View User Profile"><span style="color:black;" title="View User Profile" class="glyphicon glyphicon-open " aria-hidden="true"></span> <m style="color:black; text" >Doreen Michael</m></th></a>
              <th>Blogger</th>
            </tr>
          </table>
        </div>
